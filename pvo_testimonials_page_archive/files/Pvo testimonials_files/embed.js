...
__d(function(g,r,i,a,m,e,d){'use strict';var n=!(void 0===g||!g.document||!g.document.createElement),t='function'==typeof WorkerGlobalScope,o={canUseDOM:n,canUseWorkers:'undefined'!=typeof Worker,canUseEventListeners:n&&!(!g.addEventListener&&!g.attachEvent),canUseViewport:n&&!!window.screen,isInWorker:t,isInBrowser:n||t};m.exports=o},7,[]);
__d(function(g,r,i,a,m,e,d){"use strict";Object.defineProperty(e,'__esModule',{value:!0});var t=!1,n=i(d[0])(function(){try{var n=Object.defineProperty({},'passive',{get:function(){t=!0}});r(d[1]).canUseDOM&&(window.addEventListener('test',null,n),window.removeEventListener('test',null,n))}catch(t){}return t}),o={capture:!1},s=(function(){function t(t){this.$EventListener1=null,this.$EventListener1=t}t.add=function(s,u,v,c){void 0===c&&(c=o);var f=c;return n()||(f='boolean'!=typeof c&&!!c.capture),s.addEventListener(u,v,f),new t(function(){s.removeEventListener(u,v,f)})};return t.prototype.remove=function(){this.$EventListener1&&(this.$EventListener1(),this.$EventListener1=null)},t})();e.default=s},4,[8,7]);
...
/*
     FILE ARCHIVED ON 18:17:06 May 19, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 06:06:38 Jan 19, 2023.
...
playback timings (ms):
  ...
  esindex: 0.013
  LoadShardBlock: 138.098 (6)
  PetaboxLoader3.datanode: 141.663 (8)
  CDXLines.iter: 125.004 (3)
  load_resource: 82.887 (2)
  PetaboxLoader3.resolve: 22.843
*/